  ...
  return (
    <div className='h-[10vh] w-full flex justify-between items-center px-6 text-black text-lg relative z-[999]'>
      ...
      <div className='h-full w-[40%] flex justify-end items-center gap-10'>
            <button onClick={() => {handleFormPopUp(); setSignUpForm(true);}}  className='px-6 h-[60%] bg-black text-white hover:text-black  transition-all duartion-100 rounded-xl hover:bg-theme-highlight'>Sign Up</button>
            <button onClick={() => {handleFormPopUp(); setSignUpForm(false);}} className='px-6 h-[60%] border-2 border-black rounded-xl transition-all duration-100 hover:bg-theme-highlight'>Log In</button>
      </div>
