  ...
  return (
    <div className='h-[10vh] w-full flex justify-between items-center px-6 text-black text-lg relative z-[999]'>
      ...
      <div className='h-full w-[40%] flex justify-end items-center gap-10'>
            ...
            <button onClick={() => {handleFormPopUp(); setSignUpForm(false);}} className='px-6 h-[60%] bg-green-500 text-white rounded-xl transition-all duration-100 hover:bg-green-600 '>Log In</button>
      </div>
